...
r"""Example using TF Lite to classify a given image using an Edge TPU.
   ...
   python3 classify_image.py \
     --model models/efficientnet-edgetpu-L_quant_edgetpu.tflite  \
...
def main():
  ...
  parser.add_argument(
      '-m', '--model', default='models/efficientnet-edgetpu-L_quant_edgetpu.tflite')
  parser.add_argument(
      '-i', '--input', default='images/gun2.jpg')
  parser.add_argument(
      '-l', '--labels',default='models/imagenet_labels.txt')
  parser.add_argument(
  ...
  for klass in classes:
    ...
    if labels.get(klass.id, klass.id) == "414  assault rifle, assault gun" or labels.get(klass.id, klass.id) == "764  revolver, six-gun, six-shooter":
        print("detected pistol")
        img2=cv2.imread("images/gun2.jpg",cv2.IMREAD_UNCHANGED)
