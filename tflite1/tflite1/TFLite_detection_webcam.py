...
while True:
    try:
        ...
        for i in range(len(scores)):
            ...
            if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0) and object_name == 'pistol'):
                ...
                if object_name == "pistol" and sc >= '90':
                    ...
                    cv2.imwrite("images/get.jpg",frame)
                    crop_img = frame[ymin:ymin+(ymax-ymin), xmin:xmin+(xmax-xmin)]
                    ...
                    cv2.imwrite("images/gun2.jpg",resized)
                    os.system('python3 TFLite_detection_image.py')
